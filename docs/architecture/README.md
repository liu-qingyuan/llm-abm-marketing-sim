...
- [Full-Pool Segmented Continuation Runtime](full-pool-segmented-continuation.md)：只读 v1 prefix、十 lane suffix、cutoff/cap/reconciliation，以及双未决 `recovery_prepared` 只读 preflight contract。
