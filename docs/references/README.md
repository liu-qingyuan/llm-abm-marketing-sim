...
| 按需 operational handoff | [Concurrent Robustness v6 本地发布交接](jinjiang-concurrent-robustness-v6-local-release-20260813.md) | final-reviewed v6 source、contract、snapshot 与 rollback identity 的唯一部署交接；执行 #182 前读取。 |
