...
| 按需 pending release | [Full-Pool 两阶段 v13 Release Readiness](full-pool-two-stage-v13-release-readiness-20260827.md) | 需要核对维护者接受 nested-v1 后的 authoritative metrics、immutable v13 Release、无授权 preflight 和 human handoff 时读取；canonical 切换前它不是 current release 或部署授权。 |
