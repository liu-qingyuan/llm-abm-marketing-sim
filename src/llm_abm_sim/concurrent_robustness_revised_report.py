...
<p>直接engage与辅助概率阈值保留0.05；v2 realized路径阈值为0.02，低于阈值仅称small_observed_difference。两类阈值与基准不混用；下方旧GPT分析继续使用其原基准。</p><details><summary>配对结果、概率／置信度差值与95%区间 / Paired comparisons</summary>{direct}</details>
