const I18N = {
  'en-US': {
    ...
    usersHelp:'Required fields: user_id plus optional interest_tags, brand_attitude, activity_score. Sensitive columns are filtered from UI summaries.',
  ...
  'zh-CN': {
    ...
    usersHelp:'必需字段：user_id；可选 interest_tags、brand_attitude、activity_score。敏感列会从 UI 摘要中过滤。',
