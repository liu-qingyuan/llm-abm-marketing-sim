...
from llm_abm_sim.providers.openai_compatible import OpenAICompatibleDecisionAdapter, ProviderConfigurationError
...
def test_manual_live_llm_gate_makes_one_decision_only_when_explicitly_ready():
    ...
    try:
        ...
        pytest.skip(f"live provider metadata ready but concrete client credentials unavailable: {exc}")
