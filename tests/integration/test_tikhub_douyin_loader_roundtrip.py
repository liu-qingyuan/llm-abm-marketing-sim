...
def test_tikhub_processed_files_roundtrip_through_existing_loader(tmp_path: Path) -> None:
    ...
    profiles.write_text(
        "user_id,user_type,follower_count,observed_activity_level,observed_influence,value_proposition,interest_tags,brand_attitude,activity_level,like_tendency,comment_tendency,share_tendency\n"
        "u1,commenter,10,0.7,0.2,green_quality,锦江酒店|绿色入住,0.0,0.7,0.5,0.2,0.2\n"
        "u2,replier,20,0.5,0.3,comfort,绿色酒店,0.0,0.5,0.5,0.2,0.2\n"
        "creator1,creator,1000,0.9,0.8,brand_official,酒店|锦江酒店,0.0,0.9,0.5,0.2,0.2\n",
        encoding="utf-8",
    )
    ...
    assert extras["observed_influence"] == "0.2"
